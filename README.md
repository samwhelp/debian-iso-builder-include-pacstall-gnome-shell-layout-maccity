...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-maccity/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-maccity/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-maccity/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-include-pacstall-gnome-shell-layout-maccity](https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-maccity)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-include-pacstall-gnome-shell-layout-maccity.git
```


> change dir to `debian-iso-builder-include-pacstall-gnome-shell-layout-maccity`

``` sh
cd debian-iso-builder-include-pacstall-gnome-shell-layout-maccity
```
...
> The resulting ISO file will be placed on `debian-iso-builder-include-pacstall-gnome-shell-layout-maccity/dist`
